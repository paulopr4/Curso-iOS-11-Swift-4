...
//  Seção 3_App_Conversores_02
//
//  Created by paulopr4 on 22/06/19.
...
class ViewController: UIViewController {
    ...
    // diferença do Guard Let para if let; Guard usado para desembrular pacote de forma
    // segura com apoio do Return
